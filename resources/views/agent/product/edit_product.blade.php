...
@section('agent')
    <div class="page-content">
        ...
        <div class="d-flex justify-content-start mb-3">
            ...
            <!-- View Product Button -->
            <a href="{{ route('product.details', ['shop' => $agent->name, 'slug' => $product->slug])}}" class="btn btn-success btn-sm d-flex align-items-center"
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="short_content" class="form-control" id="exampleFormControlTextarea1" rows="10" placeholder="N/A">{{ old('short_content', $product->content) }}</textarea>
                                                @error('short_content')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
